...
var $addCollectionButton = $(
  '<button type="button" class="add_collection_link btn btn-outline-primary">Ajouter un intervenant</button>'
);
var $delCollectionButton = $(
  '<button type="button" class="del_collection_link btn btn-outline-primary">Supprimer</button>'
);
